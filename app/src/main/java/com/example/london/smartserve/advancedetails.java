...
public class advancedetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabasemembers.child("details").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(advancedetails.this).load(nsimage).into(mMemberphoto);
            }
        ...
        mDatabasemembers.child("advances").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                String currloan=(String)dataSnapshot.child("currentadvance").getValue();
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<advance,loansViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<advance, loansViewHolder>(

                advance.class,
                R.layout.loanshist_row,
                loansViewHolder.class,
                mDatabasemembers.child("advances").child("advancesss")
        )
        {
            @Override
            protected void populateViewHolder(final loansViewHolder viewHolder, final advance model, int position) {

                viewHolder.setDate(model.getDate());
                viewHolder.setLoanbf(model.getAdvbf());
                viewHolder.setInst(model.getPaid());
