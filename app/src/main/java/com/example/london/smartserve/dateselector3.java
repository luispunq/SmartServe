...
public class dateselector3 extends AppCompatActivity {
                ...
                mDone.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(dateFormated!=null){
                            ...
                            Toast.makeText(dateselector3.this, "Please select date..", Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
    ...
    private void confirmDate(String date) {
        Intent back=new Intent(dateselector3.this,mpesareport.class);
