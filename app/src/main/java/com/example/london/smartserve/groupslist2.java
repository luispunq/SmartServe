...
public class groupslist2 extends AppCompatActivity {
            ...
            protected void populateViewHolder(final GroupViewholder viewHolder, final groups model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent next = new Intent(groupslist2.this,memberlista.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.action_logout){
            ...
            Intent loggetout=new Intent(groupslist2.this,Main.class);
